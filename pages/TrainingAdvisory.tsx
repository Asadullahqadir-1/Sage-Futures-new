    ...
    <div className="min-h-screen bg-gradient-to-b from-brand-offwhite via-white to-brand-offwhite/80 pt-20 sm:pt-24 pb-12 sm:pb-24">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12 sm:space-y-16">
        <Reveal as="section" className="space-y-4 sm:space-y-6">
          ...
          <p className="text-sm sm:text-base md:text-lg text-brand-charcoal/80 leading-relaxed max-w-3xl">
          ...
          <p className="text-xs sm:text-sm md:text-base text-brand-charcoal/70 leading-relaxed max-w-3xl italic">
        ...
        <div className="border-t border-brand-stone/30 my-8 sm:my-12"></div>
        ...
        <Reveal
          as="section"
          className="bg-brand-sage text-brand-offwhite px-6 sm:px-8 md:px-10 py-8 sm:py-10 md:py-12 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 sm:gap-6 rounded-lg"
          delayMs={240}
        >
          <div className="space-y-2 sm:space-y-3 max-w-2xl">
            <h2 className="text-lg sm:text-xl md:text-2xl font-serif">Work With Us</h2>
            <p className="text-xs sm:text-sm md:text-base text-brand-offwhite/90 leading-relaxed">
          ...
          <div className="flex flex-col items-start md:items-end w-full md:w-auto">
            <button
              ...
              className="w-full md:w-auto bg-white text-brand-sage px-6 sm:px-8 py-3 sm:py-4 text-xs font-bold uppercase tracking-[0.2em] sm:tracking-[0.25em] border border-transparent hover:bg-brand-brass hover:text-white transition-all duration-300 transform hover:-translate-y-0.5 active:translate-y-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-brand-sage focus-visible:ring-brand-brass"
            >
